...
const Mading = () => {
  ...
  //  RENDER
  return (
    <div className="h-[100svh] w-full bg-[var(--background)] flex flex-col">
      {/* MAIN CONTENT */}
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-[2fr_3fr] gap-4 p-4 overflow-hidden">
        {/* LEFT IMAGE */}
      ...
      <div className="px-4 py-3">
        <h2 className="text-subtitle font-bold text-primary mb-3">Berita Terbaru</h2>
